...
(6, 'Kenneth', 'Bonita', 'kenneth.bonita07@gmail.com', '123'),
(7, 'Kenneth', 'Bonita', 'kenneth', '123'),
(8, 'Kenneth', 'Bonita', 'kenneth123', '123');
...
(9, 'Dsa', NULL, 'dsa', 'dSa', 'false', 8),
(10, 'test2 test2 test2', NULL, 'dwasdwa', 'jpegdwa', 'false', 13),
(11, 'matcha', NULL, 'sago, pearl', 'dwasd', 'false', 15),
(12, 'username', NULL, 'dasdasd', 'sadsa', 'false', 8),
(13, 'test_product', NULL, 'sago, okinawa', 'dwf', 'false', 16),
(14, 'test2 prod', NULL, 'okinawa, strawberry', 'test2 description', 'false', 17),
(15, 'test2 prod', NULL, 'Strawberry', 'Good', 'false', 18),
(16, 'test2 prod', NULL, 'sss', 'jpeg', 'false', 18),
(17, 'tes3 prod', NULL, 'test ingredients', 'test3 description', 'false', 19),
(18, 'tes3 prod', NULL, 'sago', 'sago', 'false', 20),
(19, 'survey_db', NULL, 'dsadas', 'dsa', 'false', 21),
(20, 'test3', NULL, 'test3', 'test3', 'false', 22),
(21, 'tes3 prod', NULL, 'test', 'test3', 'false', 23),
(22, 'Milktea malamig', NULL, 'sago, taho, strawberry', 'malamig', 'false', 24),
(23, 'Milktea Taho flavor', NULL, 'sago, taho, asukal', 'milktea taho flavor', 'false', 25),
(24, 'ss', NULL, 'ss', 'ss', 'false', 26),
(25, 'Milktea Sago', NULL, 'Milktea Sago', 'Milktea Sago', 'false', 27),
(26, 'tes3 prod', NULL, 'sago', 'sago', 'false', 8),
(27, 'Milktea Okinawa', NULL, 'sago, taho, pearl', 'malamig', 'false', 18),
(28, 'test1 test1 test1', NULL, 'test3', 'test3', 'false', 17);
...
(11, ' Milktea Taho    ', ' Matcha with milktea    ', NULL, NULL, 'Social Media', ' Masarap pala    ', 'false'),
(12, '  Matcha Milktea and Burgers  ', '  Malamig na milktea  ', NULL, NULL, 'Social Media', '  masarap pala sulit nice ', 'false'),
(13, ' milk tea pero hiwalay yung tea ', ' pinag hiwalay yung milk saka tea ', NULL, NULL, 'Online Forum', ' malupet ', 'false'),
(14, ' milk tea pero hiwalay yung tea ', ' Malamig na milktea ', NULL, NULL, 'Online Forum', ' masarap pala sulit ', 'false'),
(15, ' Matcha Milktea and Burgers ', ' pinag hiwalay yung milk saka tea ', NULL, NULL, 'Social Media', ' masarap pala sulit ', 'false'),
(16, ' test ', ' test ', NULL, NULL, 'Customer Survey', ' test ', 'false'),
(17, ' test2 ', ' test2 ', NULL, NULL, 'Social Media', ' test2 ', 'false'),
(18, '  Milktea matabang Okinawa  ', '  Matabang daw yung okinawa  ', NULL, NULL, 'Social Media', ' The new flavor is good ', 'false'),
(19, ' Matcha Milktea ', ' Malamig na milktea ', NULL, NULL, 'Customer Survey', ' masarap naman ', 'false'),
(20, ' Matcha Milktea ', ' Matcha with milktea ', NULL, NULL, 'Online Forum', ' ang galing ', 'false'),
(21, ' Matcha Milktea ', ' Matcha with milktea ', NULL, NULL, 'Online Forum', ' masarap pala ', 'false'),
(22, ' test3 ', ' test3 ', NULL, NULL, 'Social Media', ' test3 ', 'false'),
(23, ' Matcha Milktea ', ' Matcha with milktea ', NULL, NULL, 'Online Forum', ' masarap pala ', 'false'),
(24, ' Milktea na Malamig ', ' Malamig na milktea ', NULL, NULL, 'Online Forum', ' masarap pala sulit ', 'false'),
(25, ' milktea taho ', ' milktea na may taho ', NULL, NULL, 'Social Media', ' masarap pala ', 'false'),
(26, ' Krusty crab ', ' Crabby patty ', NULL, NULL, 'Online Forum', ' good ', 'false'),
(27, ' Milktea Sago ', ' Milktea Sago ', NULL, NULL, 'Online Forum', ' Milktea Sago ', 'false'),
(28, ' milktea taho ', ' Matcha with milktea ', NULL, NULL, 'Online Forum', ' ang galing ', 'false'),
(29, 'milktea taho', 'Matcha with milktea', NULL, NULL, 'online_forum', 'masarap pala', 'false');
