...
<html lang="en">
	...
	<link rel="icon" type="image/x-icon" href="/images/favicon.ico">
	    ...
	    <title>Violetea Cafe Home Page</title>
		...
		<link href='http://fonts.googleapis.com/css?family=Poppins:300,400,500,700' rel='stylesheet' type='text/css'>
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(front/cover.jpg);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(front/2.1.png);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->

		<div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(front/3.png);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
		

		<div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(front/banner4.png);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->

		<div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(front/6.1.png);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">MILKTEA, FRAPPE</h4>
						</div>
					</div>	
					<h6 class="text" style="text-align:justify">wide variety of tasty and refreshing authentic drinks for all you fanatics out there </h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">BURGER, FRIES</h4>
						</div>
					</div>
					<h6 class="text" style="text-align:justify">100% pure beef burger. Enjoy the tempting tastes of a juicy cheeseburger and fries combo</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading red">AND MANY MORE</h4>
						</div>
					</div>
					<h6 class="text">A TASTY LINE UP PLUS SO MUCH MORE SWEETS THAT WILL ENJOY AND love by many Filipinos.</h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">MILK TEA AND FRAPPE</h3>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">BURGER AND FRIES</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
...
<?php }?>
					...
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">CAKES AND PASTRIES</h3>
	                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">PASTA AND MORE</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
$ret=mysqli_query($con,"select * from products where category=5");
while ($row=mysqli_fetch_array($ret)) 
